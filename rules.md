...
1. Проверка ДЗ действует 4,5 месяца с момента нажатия кнопки "Принять участие" в личном кабинете
1. Взаимодействие с наставником проходит по следующей схеме:
    ...
    - если все верно, то наставник напишет, чтобы вы выполняли следующее ДЗ или переходили к следующему уроку
...
1. Если у вас закончился срок проверок ДЗ, то его можно продлить в личном кабинете (ссылка на него есть в любом нашем письме) [на сайте](https://javaops.ru/)
