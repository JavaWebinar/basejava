...
1) Переделайте модель резюме: учесть, что на одной работе (в одном учебном заведении) можно работать/учиться в разные периоды. При этом имя организации и ссылка на сайт не должны дублироваться
2) Сделайте рекурсивный обход и вывод имени файлов в каталогах и подкаталогах (корневой каталог- ваш проект)
...
4) Реализуйте `AbstractFileStorage`, базовый класс для хранения резюме в файлах
