...
2) Реализуйте рекурсивный обход и вывод имени файлов в директориях и поддиректориях, начиная с корня вашего проекта
3) Реализуйте в `ResumeTestData` метод, который:
