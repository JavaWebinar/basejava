...
- int size и STORAGE_LIMIT относятся только к массивам, в списке и мапе нет необходимости их использовать, будем считать их условно безразмерными
- при поиске uuid не надо использовать методы, который сравнивают объекты резюме по equals, в следующих уроках добавим еще поля в резюме и в equals и данный вариант не подойдет
