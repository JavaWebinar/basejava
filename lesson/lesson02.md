...
- Чтобы было понятно, к чему относятся те или иные коммиты, в начале описания каждого из них добавляйте префиксы lesson_n: или hw_n:
  - для описания изменений, выполненных Григорием в уроке, добавляйте lesson_n: (например, `lesson_2: описание`)
  - если изменения связаны с вашей реализацией ДЗ, то добавляйте hw_n: (например, `hw_2: описание`)
- Реализацию каждого пункта ДЗ размещайте в отдельном коммите
- Для изменения коммитов используйте [rebase](https://www.youtube.com/watch?v=smUBOQhG1IM)
