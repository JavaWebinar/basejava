...
- Чтобы было понятно, к чему относятся те или иные коммиты, в начале описания каждого из них добавляйте префиксы:
  - **lesson_n:** для описания изменений, выполненных Григорием в уроке (например, `lesson_2: описание`)
  - **hw_n:** если изменения связаны с вашей реализацией ДЗ (например, `hw_2: описание`)
