...
- **ПРОВЕРЬТЕ свою модель: создайте в классе ResumeTestData объект `Resume` и заполните все его разделы данными, взятыми из [**Образца резюме**](https://javawebinar.github.io)**  
