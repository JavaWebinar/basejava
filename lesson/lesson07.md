...
- **ПРОВЕРЬТЕ свою модель: создайте класс ResumeTestData с методом main, а в нем объект `Resume` и заполните все его разделы данными, взятыми из [**Образца резюме**](http://javaops-demo.ru/basejava/resume?uuid=11111111-1111-1111-1111-111111111111&action=view&theme=light). Выведите все секции на консоль**
