...
- Реализуйте для getAllSorted() компаратор, используя методы интерфейса [Comparator](https://www.baeldung.com/java-8-comparator-comparing): если `fullName` разных людей совпадает, то сортируйте дополнительно по uuid
