...
- Из-за того, что количество тестовых классов растет, воспользуйтесь [аннотациями](https://www.geeksforgeeks.org/software-testing/junit-5-test-suites-with-example/) JUnit, которые помогут упростить их запуск (для `JUnit5` добавьте в `Dependencies` зависимость `platform-suite`). Отформатируйте класс-запуска тестов в соответствии с [этой](https://github.com/user-attachments/assets/11670798-14f7-41ff-a03c-dbf5a900671f) картинкой
