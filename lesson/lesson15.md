...
- <a href="https://developer.mozilla.org/ru/docs/Web/HTTP/Overview">Протокол HTTP</a>. Смотрим [демо приложение](https://javaops-demo.ru/topjava/login) в Chrome -> Инструменты разработчика
